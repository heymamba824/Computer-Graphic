...
void    Animate(int MS_IN_THE_ANIMATION_CYCLE, int axis );
void    Display( );
void    DoAxesMenu( int );
void    Changeview(int);
...
void
Animate( int MS_IN_THE_ANIMATION_CYCLE, int axis)
{
    float Time;
    ...
    switch(axis){
        case 1:
        glRotatef(20 * Time * 360,1,0,0);
        break;
        case 2:
        glRotatef(10 * Time * 360,0,1,0);
        break;
        default:
...
Display( )
{
    ...
    glColor3f( 0., 1., 1. );
    DoRasterString( 0., 1., 0., (char *)"Rocket" );
    ...
    glLoadIdentity( );
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., (char *)"Kaiyu Liao Project1 liaoka@oregonstate.edu" );
...
InitMenus( )
{
    ...
    int viewchange = glutCreateMenu( ChangeView);
    glutAddMenuEntry( "out",  0 );
    ...
    glutAddSubMenu(   "View",        viewchange);
